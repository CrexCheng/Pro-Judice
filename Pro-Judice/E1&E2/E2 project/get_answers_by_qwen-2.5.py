...
# 读取 Excel 文件
df = pd.read_excel('data/prompts_E2_en.xlsx', header=None, skiprows=1, nrows=1000)
case_id = df[0].tolist()
...
df.to_excel('E2_output_en/E2_en_results_qwen.xlsx', index = False)
print("表格已保存至 E2_output_en/E2_en_results_qwen.xlsx.")
